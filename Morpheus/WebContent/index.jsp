    ...
    <div class="navbar navbar-inverse navbar-fixed-top">
      <div class="container">
        ...
        <div class="collapse navbar-collapse">
          ...
          <form class="navbar-form navbar-right" action="userController?user=loginUser" method="post">
          <fieldset>
            ...
            <button type="submit" class="btn btn-success" value="Login" onClick="return validate();" >
              Admin Sign-In
            </button>
            </fieldset>
          </form>
     ...
     <div class="jumbotron">
      ...
      <div class="col-md-6">
        ...
        <form action="userController?user=logincompany" method="post">
            ...
            <br>
            <input type="text" id="cname" name="email" class="form-control"/>
            <br>
            <label><font color="FFFFFF">Password</font></label>
            <input type="password" id="cpassword" name="password" class="form-control"/>
            <br>
            <tr><td align="center"><input type="submit"  class="btn btn-default" value="Company Admin Log-in" onClick="return validations();"> </td>
      ...
      <h1><font color="FFFFFF">
        ...
        <p class="lead">
            ...
            <form action="userController?user=loginemployee" method="post">
            <fieldset>
            <label><font color="FFFFFF">
              Email
            </font></label>
            <br>
            <input type="text" id="sname" name="email" class="form-control"/>
            <br>
            <label><font color="FFFFFF">Password</font></label>
            <input type="password" id="spassword" name="password" class="form-control"/>
            <br>
            <tr><td align="center"><input type="submit"  class="btn btn-default" value="Employee Log-in" onClick="return validation();"> </td>
			<td><input type="hidden" name="user" value="loginUser"></td>
			</tr> 
			</fieldset>     
        </form>             
