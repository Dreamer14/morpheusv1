...
<%@page import="java.util.ArrayList"%><html>
  ...
  %>
      ...
      <tr>
         ...
         <td><%=su.getAbn()%></td>
         <td><a href="userController?user=EditCompanyRecord&productID=<%=su.getProductID()%>" class="btn btn-default">Edit</a></td> 
         <td><a href="userController?user=deleteIssueRecord&productID=<%=su.getProductID()%>" class="btn btn-default">Delete</a></td>
      </tr>
    <tr>  
